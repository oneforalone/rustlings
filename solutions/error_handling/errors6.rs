    ...
    -> Result<PositiveNonzeroInteger, ParsePosNonzeroError>
{
    ...
    //         Err(CreationError::Negative) => Err(ParsePosNonzeroError::Creation(CreationError::Negative)),
    //         Err(CreationError::Zero) => Err(ParsePosNonzeroError::Creation(CreationError::Zero)),
    //     }
